            ...
            <div className="widthFull flex center align-center column gap10 vertFonce">
                <div className="about flex center widthFull padding10 column">
                    <div className="heightFull flex center column relative">
                        <h2 className="flex center shadow absolute">About </h2>
                        <div className="flex center align-center widthFull">
                            <div className=" flex center align-center column gap10">
                                <p className="text">Je suis un développeur web passionné par la création de sites internet et d'applications web. J'aime relever des défis techniques et trouver des solutions innovantes pour répondre aux besoins de mes clients.</p>
                            </div>
                        </div>
                    </div>
                </div>
