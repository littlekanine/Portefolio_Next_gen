			...
			<div className="about__container">
				...
				<div className="about__content">
					<div className="about__column about__column--left">
						{/* <img src="https://placehold.co/400x500" alt="Professional headshot" className="about__image" /> */}
					...
					<div className="about__column about__column--right">
						<p className="about__description">
							Je suis un développeur web passionné par la création de sites internet et d'applications web. J'aime relever des défis techniques et trouver des
							solutions innovantes pour répondre aux besoins de mes clients.
						</p>
